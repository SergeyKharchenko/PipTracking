...
#define ApplicationName "PipTracking v1.4"

AppName    = PipTracking v1.4
AppVersion = 1.4
...
OutputBaseFilename = PipTracking v1.4
...
#define outFiles[0] "experts\PipTracking v1.4.mq4"
#define outFiles[1] "experts\PipTracking v1.4.ex4"
