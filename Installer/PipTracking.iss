...
#define ApplicationName "PipTracking v1.0"

AppName    = PipTracking v1.0
AppVersion = 1.0
...
OutputBaseFilename = PipTracking v1.0
...
#define outFiles[0] "experts\PipTracking v1.0.mq4"
#define outFiles[1] "experts\PipTracking v1.0.ex4"
