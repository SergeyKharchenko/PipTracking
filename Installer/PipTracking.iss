...
#define ApplicationName "PipTracking v0.4"

AppName    = PipTracking v0.4
AppVersion = 0.4
...
OutputBaseFilename = PipTracking v0.4
...
#define outFiles[0] "experts\PipTracking v0.4.mq4"
#define outFiles[1] "experts\PipTracking v0.4.ex4"
