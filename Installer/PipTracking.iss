...
#define ApplicationName "PipTracking v0.1"

AppName    = PipTracking v0.1
AppVersion = 0.1
...
OutputBaseFilename = PipTracking v0.1
...
#define outFiles[0] "experts\PipTracking v0.1.mq4"
#define outFiles[1] "experts\PipTracking v0.1.ex4"
