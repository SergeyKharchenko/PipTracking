...
#define ApplicationName "PipTracking v0.2"

AppName    = PipTracking v0.2
AppVersion = 0.2
...
OutputBaseFilename = PipTracking v0.2
...
#define outFiles[0] "experts\PipTracking v0.2.mq4"
#define outFiles[1] "experts\PipTracking v0.2.ex4"
