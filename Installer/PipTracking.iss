...
#define ApplicationName "PipTracking v1.27"

AppName    = PipTracking v1.27
AppVersion = 1.27
...
OutputBaseFilename = PipTracking v1.27
...
#define outFiles[0] "experts\PipTracking v1.27.mq4"
#define outFiles[1] "experts\PipTracking v1.27.ex4"
