...
#define ApplicationName "PipTracking v1.9"

AppName    = PipTracking v1.9
AppVersion = 1.9
...
OutputBaseFilename = PipTracking v1.9
...
#define outFiles[0] "experts\PipTracking v1.9.mq4"
#define outFiles[1] "experts\PipTracking v1.9.ex4"
