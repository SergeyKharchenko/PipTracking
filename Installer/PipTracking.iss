...
#define ApplicationName "PipTracking v1.8"

AppName    = PipTracking v1.8
AppVersion = 1.8
...
OutputBaseFilename = PipTracking v1.8
...
#define outFiles[0] "experts\PipTracking v1.8.mq4"
#define outFiles[1] "experts\PipTracking v1.8.ex4"
