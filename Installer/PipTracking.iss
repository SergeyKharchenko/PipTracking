...
#define ApplicationName "PipTracking v1.26"

AppName    = PipTracking v1.26
AppVersion = 1.26
...
OutputBaseFilename = PipTracking v1.26
...
#define outFiles[0] "experts\PipTracking v1.26.mq4"
#define outFiles[1] "experts\PipTracking v1.26.ex4"
