...
#define ApplicationName "PipTracking v1.7"

AppName    = PipTracking v1.7
AppVersion = 1.7
...
OutputBaseFilename = PipTracking v1.7
...
#define outFiles[0] "experts\PipTracking v1.7.mq4"
#define outFiles[1] "experts\PipTracking v1.7.ex4"
