...
#define ApplicationName "PipTracking v1.2"

AppName    = PipTracking v1.2
AppVersion = 1.2
...
OutputBaseFilename = PipTracking v1.2
...
#define outFiles[0] "experts\PipTracking v1.2.mq4"
#define outFiles[1] "experts\PipTracking v1.2.ex4"
