...
#define ApplicationName "PipTracking v1.12"

AppName    = PipTracking v1.12
AppVersion = 1.12
...
OutputBaseFilename = PipTracking v1.12
...
#define outFiles[0] "experts\PipTracking v1.12.mq4"
#define outFiles[1] "experts\PipTracking v1.12.ex4"
