...
#define ApplicationName "PipTracking v1.25"

AppName    = PipTracking v1.25
AppVersion = 1.25
...
OutputBaseFilename = PipTracking v1.25
...
#define outFiles[0] "experts\PipTracking v1.25.mq4"
#define outFiles[1] "experts\PipTracking v1.25.ex4"
