...
#define ApplicationName "PipTracking v1.28"

AppName    = PipTracking v1.28
AppVersion = 1.28
...
OutputBaseFilename = PipTracking v1.28
...
#define outFiles[0] "experts\PipTracking v1.28.mq4"
#define outFiles[1] "experts\PipTracking v1.28.ex4"
