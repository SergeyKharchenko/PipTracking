...
#define ApplicationName "PipTracking v1.11"

AppName    = PipTracking v1.11
AppVersion = 1.11
...
OutputBaseFilename = PipTracking v1.11
...
#define outFiles[0] "experts\PipTracking v1.11.mq4"
#define outFiles[1] "experts\PipTracking v1.11.ex4"
