...
#define ApplicationName "PipTracking v1.24"

AppName    = PipTracking v1.24
AppVersion = 1.24
...
OutputBaseFilename = PipTracking v1.24
...
#define outFiles[0] "experts\PipTracking v1.24.mq4"
#define outFiles[1] "experts\PipTracking v1.24.ex4"
