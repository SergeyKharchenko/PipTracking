...
#define ApplicationName "PipTracking v1.3"

AppName    = PipTracking v1.3
AppVersion = 1.3
...
OutputBaseFilename = PipTracking v1.3
...
#define outFiles[0] "experts\PipTracking v1.3.mq4"
#define outFiles[1] "experts\PipTracking v1.3.ex4"
