...
#define ApplicationName "PipTracking v1.1"

AppName    = PipTracking v1.1
AppVersion = 1.1
...
OutputBaseFilename = PipTracking v1.1
...
#define outFiles[0] "experts\PipTracking v1.1.mq4"
#define outFiles[1] "experts\PipTracking v1.1.ex4"
