...
#define ApplicationName "PipTracking v1.13"

AppName    = PipTracking v1.13
AppVersion = 1.13
...
OutputBaseFilename = PipTracking v1.13
...
#define outFiles[0] "experts\PipTracking v1.13.mq4"
#define outFiles[1] "experts\PipTracking v1.13.ex4"
